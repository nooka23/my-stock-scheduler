    ...
    >
      <div className="absolute right-3 top-3 z-20">
        <button
          ...
          className="rounded-full border border-[var(--border)] bg-white/90 px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-[var(--shadow-sm)] backdrop-blur hover:bg-white"
        >
