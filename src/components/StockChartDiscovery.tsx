...
export default function StockChartDiscovery({ data = [], colors: {
  ...
  useEffect(() => {
    ...
    const chart: IChartApi = createChart(chartContainerRef.current, {
      ...
      height: chartContainerRef.current.clientHeight, // 초기 높이는 clientHeight 사용
      ...
      rightPriceScale: {
        ...
        priceFormat: { type: 'price', precision: 0 }, // 소수점 제거
      },
