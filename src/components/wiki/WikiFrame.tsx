...
export default function WikiFrame({ children }: { children: React.ReactNode }) {
  return <>
    <header className="wiki-nav"><div className="wiki-nav-inner">
      ...
      <nav className="wiki-nav-links"><Link href="/wiki">문서</Link><Link href="/wiki/new">새 문서</Link><Link href="/wiki/settings">내보내기</Link><Link className="wiki-nav-back" href="/">기존 사이트로</Link></nav>
