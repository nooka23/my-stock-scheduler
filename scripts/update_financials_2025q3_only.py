...
def collect_2025q3_all_companies(api_limit=9500, target_codes=None):
    """2025년 3분기 데이터를 모든 종목에 대해 수집"""

    TARGET_YEAR = 2025
    TARGET_QUARTER = 3

    print(f"\n2025년 Q3 데이터 전체 수집 시작")
    if target_codes:
    ...
    excel_filename = f'2025Q3_collection_result_{timestamp}.xlsx'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Update 2025 Q3 financials.')
    ...
    collect_2025q3_all_companies(api_limit=9500, target_codes=target_codes)
